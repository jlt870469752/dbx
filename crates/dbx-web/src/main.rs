...
fn add_mq_routes(router: Router<Arc<WebState>>) -> Router<Arc<WebState>> {
    router
        ...
        .route("/mq/subscriptions/peek-range", post(routes::mq::peek_messages_range))
        .route("/mq/subscriptions/read-session/start", post(routes::mq::start_read_session))
        .route("/mq/subscriptions/read-session/next", post(routes::mq::read_session_next))
        .route("/mq/subscriptions/read-session/close", post(routes::mq::close_read_session))
