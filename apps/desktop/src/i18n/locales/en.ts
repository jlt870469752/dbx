...
export default {
  ...
  grid: {
    ...
    formatterForeignKeyReferenceInvalid: "This column is missing or is not a valid single-column unique key. Select another column.",
    formatterForeignKeyReferenceUnavailable: "The target table has no usable single-column unique key.",
  ...
  welcome: {
    ...
    keyboardShortcutsHint: "Shows the shortcuts currently active in your app",
    shortcutQuickOpen: "Quick Search",
    shortcutQuickOpenDescription: "Open Search Everywhere with a double Shift press or the shortcut below.",
    shortcutQuickOpenCategory: "Switch Search Category",
    shortcutQuickOpenCategoryDescription: "Cycle categories inside quick search while keeping the cursor in the input.",
    shortcutNewQuery: "New Query",
    shortcutNewQueryDescription: "Open a fresh query tab right away.",
    shortcutExecuteSql: "Run SQL",
    shortcutExecuteSqlDescription: "Execute the SQL in the current editor.",
    shortcutFocusTableWhere: "Focus Table WHERE Query",
    shortcutFocusTableWhereDescription: "Focus the WHERE query input directly on a table data page.",
    shortcutSwitchTab: "Switch Tabs",
    shortcutSwitchTabDescription: "Move between the previous and next query tabs.",
    shortcutOpenSettings: "Open Settings",
    shortcutOpenSettingsDescription: "Adjust editor, theme, and shortcut preferences.",
    shortcutThen: "then",
  ...
  quickOpen: {
    ...
    databaseScope: "Data sources",
    scopeContext: "Context data source",
    scopeConnected: "Connected data sources",
    scopeAll: "All data sources",
    connected: "Connected",
    navigate: "Navigate",
    select: "Select",
    close: "Close",
    ...
    actionDescription: "Application action",
    actions: {
      newQuery: "New Query",
      openSettings: "Open Settings",
      openShortcuts: "Open Shortcut Settings",
      openDriverStore: "Open Driver Manager",
      openHistory: "Open Query History",
      openSqlLibrary: "Open SQL Library",
      openSqlFiles: "Open SQL Files",
      toggleSidebar: "Toggle Sidebar",
      openDataTransfer: "Open Data Transfer",
      refreshCurrent: "Refresh Current View",
      executeSql: "Execute Current SQL",
      formatSql: "Format Current SQL",
      saveSql: "Save Current SQL",
      closeTab: "Close Current Tab",
      focusTableWhere: "Focus Table WHERE Query",
      toggleTranspose: "Toggle Grid Transpose View",
      showDdl: "Show Current Table DDL",
  ...
  settings: {
    ...
    updateDownloadSourceMyfork: "My Fork",
    ...
    kafkaUseReadSession: "Use Kafka read sessions",
    kafkaUseReadSessionDescription: "Use the Kafka range and session cursor protocol for message browsing and offset searches. Disabled by default.",
    ...
    save: "Save",
    cancel: "Cancel",
    executeMode: "Execute Mode ({shortcut})",
    ...
    shortcutFocusSearch: "Focus current view search / SQL Find",
    shortcutFocusTableWhere: "Focus table WHERE query",
  ...
  mqMessages: {
    ...
    kafkaOffset: "Read by offset range",
    kafkaOffsetRangeHint: "Read pages from the start offset (inclusive) to the end offset (exclusive). Empty bounds use the readable partition range.",
    pageSize: "Page size",
    customPageSize: "Custom",
    startOffset: "Start offset",
    endOffset: "End offset",
    endOffsetPlaceholder: "Empty = current end",
    filterRangePlaceholder: "Find messages in the offset range",
    scanRange: "Scan range",
    scanning: "Scanning...",
    scanProgress: "Scanning page {current} / {total}",
    scanSessionRetry: "Read session expired; restarting scan ({attempt}/3)",
    readProgress: "Reading current page",
    scanMatched: "Match found on page {page}",
    scanNoMatch: "No matching message in the offset range",
    startOffsetMustBeNonNegativeInt: "Start offset must be a non-negative integer",
    endOffsetMustBeNonNegativeInt: "End offset must be a non-negative integer",
    endOffsetMustBeGreaterThanStart: "End offset must be greater than start offset",
    pageOutOfRange: "The current page is outside the offset range",
    previousPage: "Previous",
    nextPage: "Next",
    currentPage: "Page {page}",
    currentOffsetRange: "Offset {start} - {end}",
    ...
    loadingMoreMessages: "Loading more...",
    allMessagesLoaded: "Reached the boundary",
