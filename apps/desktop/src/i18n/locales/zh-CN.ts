...
export default withEnglishFallback({
  ...
  grid: {
    ...
    formatterForeignKeyReferenceInvalid: "该字段不存在，或不是有效的单列唯一键。请重新选择。",
    formatterForeignKeyReferenceUnavailable: "目标表没有可用的单列唯一键。",
  ...
  welcome: {
    ...
    keyboardShortcutsHint: "显示当前生效的常用快捷键",
    shortcutQuickOpen: "快速搜索",
    shortcutQuickOpenDescription: "打开 Search Everywhere，支持双击 Shift 或使用快捷键唤起。",
    shortcutQuickOpenCategory: "切换搜索分类",
    shortcutQuickOpenCategoryDescription: "在快速搜索中切换分类，焦点保持在输入框，可继续直接输入。",
    shortcutNewQuery: "新建查询",
    shortcutNewQueryDescription: "直接新建一个查询标签页。",
    shortcutExecuteSql: "执行 SQL",
    shortcutExecuteSqlDescription: "运行当前编辑器中的 SQL。",
    shortcutFocusTableWhere: "聚焦表数据 WHERE 查询",
    shortcutFocusTableWhereDescription: "在表数据页直接聚焦 WHERE 查询输入框。",
    shortcutSwitchTab: "切换标签页",
    shortcutSwitchTabDescription: "在左右相邻的查询标签之间快速切换。",
    shortcutOpenSettings: "打开设置",
    shortcutOpenSettingsDescription: "打开设置页面调整编辑器、主题和快捷键。",
    shortcutThen: "然后",
    sqlHistory: "历史查询",
  ...
  quickOpen: {
    ...
    sqlFile: "SQL文件",
    sqlLibraryFile: "SQL库",
    actionDescription: "应用操作",
    actions: {
      newQuery: "新建查询",
      openSettings: "打开设置",
      openShortcuts: "打开快捷键设置",
      openDriverStore: "打开驱动管理",
      openHistory: "打开查询历史",
      openSqlLibrary: "打开 SQL 库",
      openSqlFiles: "打开 SQL 文件",
      toggleSidebar: "显示/隐藏侧边栏",
      openDataTransfer: "打开数据传输",
      refreshCurrent: "刷新当前页面",
      executeSql: "执行当前 SQL",
      formatSql: "格式化当前 SQL",
      saveSql: "保存当前 SQL",
      closeTab: "关闭当前标签页",
      focusTableWhere: "聚焦表数据 WHERE 查询",
      toggleTranspose: "切换表格转置视图",
      showDdl: "查看当前表 DDL",
      toggleAi: "打开/关闭 AI 助手",
    },
  },
  explain: {
    title: "执行计划",
  ...
  settings: {
    ...
    updateDownloadSourceMyfork: "我的 Fork",
    ...
    kafkaUseReadSession: "使用 Kafka 读取会话",
    kafkaUseReadSessionDescription: "消息浏览和 Offset 搜索使用 Kafka 合并读取及会话游标协议，默认关闭。",
    ...
    shortcutFocusSearch: "聚焦当前页面搜索 / SQL 查找",
    shortcutFocusTableWhere: "聚焦表数据 WHERE 查询",
  ...
  mqMessages: {
    ...
    kafkaEarliest: "最早消息",
    kafkaOffset: "按 Offset 区间读取",
    kafkaOffsetRangeHint: "按起始 Offset（含）到结束 Offset（不含）分页读取；留空时使用分区当前可读范围。",
    pageSize: "每页数量",
    customPageSize: "自定义",
    startOffset: "起始 Offset",
    endOffset: "结束 Offset",
    endOffsetPlaceholder: "留空=当前末尾",
    filterRangePlaceholder: "在 Offset 区间内查找消息",
    scanRange: "扫描区间",
    scanning: "扫描中...",
    scanProgress: "正在扫描第 {current} / {total} 页",
    scanSessionRetry: "读取会话已过期，正在重新扫描（第 {attempt}/3 次）",
    readProgress: "正在读取当前页",
    scanMatched: "已在第 {page} 页找到匹配消息",
    scanNoMatch: "当前 Offset 区间没有匹配消息",
    startOffsetMustBeNonNegativeInt: "起始 Offset 必须是大于等于 0 的整数",
    endOffsetMustBeNonNegativeInt: "结束 Offset 必须是大于等于 0 的整数",
    endOffsetMustBeGreaterThanStart: "结束 Offset 必须大于起始 Offset",
    pageOutOfRange: "当前页超出 Offset 区间",
    previousPage: "上一页",
    nextPage: "下一页",
    ...
    loadMoreMessages: "继续加载",
    loadingMoreMessages: "加载更多中...",
    allMessagesLoaded: "已加载到边界",
